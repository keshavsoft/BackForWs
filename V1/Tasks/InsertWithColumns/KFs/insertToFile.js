...
const StartFunc = ({LocalCoumnclassName,LocalCoumnstart,LocalCoumntitle}) => {
  const LocalFileName = ParamsJson.TableName;
  const LocalDataPath = ParamsJson.DataPath;

  let LocalinDataToInsert = {className : LocalCoumnclassName,start : LocalCoumnstart,title : LocalCoumntitle};
